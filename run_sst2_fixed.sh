...
python code/eval_accuracy.py --model ${MODEL_PATH} --adapter runs/qwen3-4b-lora --data data/sst2_val.json --output runs/qwen3-4b-lora/eval_results.json --batch-size 32
